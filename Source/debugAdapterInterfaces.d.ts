...
export interface IInitializeRequestArgs
	extends DebugProtocol.InitializeRequestArguments {
...
export interface ISetBreakpointsArgs
	extends DebugProtocol.SetBreakpointsArguments {
	authoredPath?: string;
}

export type ISetBreakpointsResponseBody =
...
export interface IInternalStackTraceResponseBody
	extends IStackTraceResponseBody {
...
export type ISetVariableResponseBody =
	DebugProtocol.SetVariableResponse["body"];

export type ICompletionsResponseBody =
	DebugProtocol.CompletionsResponse["body"];

export type IGetLoadedSourcesResponseBody =
...
export interface IDebugAdapter {
	...
	evaluate(
		...
		telemetryPropertyCollector?: ITelemetryPropertyCollector,
		requestSeq?: number,
	): PromiseOrNot<IEvaluateResponseBody>;
}
